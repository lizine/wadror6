...
describe "beerlist page" do
  ...
  it "shows styles in alphabetical order when user clicks styles link", js: true do
    visit beerlist_path
    click_link "Style"
     save_and_open_page
   ...
   it "shows breweries in alphabetical order when user clicks beweries link", js: true do
    visit beerlist_path
    click_link "Brewery"
     save_and_open_page
